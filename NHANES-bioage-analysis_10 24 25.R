...
## For indexing after running if neded 
...
for (i in seq_along(1:m)) {
  ...
  model_0_ses <- function(y){
    ...
    fit <- svyglm(f_unadj, design=dstrat, na.action=na.exclude)
    fit
  }
...
for (i in seq_along(1:m)) {
  ...
  model_1_ses <- function(y){
    ...
    fit <- svyglm(f_m1, design=dstrat, na.action=na.exclude)
    fit
  }
...
for (i in seq_along(1:m)) {
  ...
  model_2_ses <- function(y){
    ...
    fit <- svyglm(f_m2, design=dstrat, na.action=na.exclude)
    fit
  }
...
for (i in seq_along(1:m)) {
  ...
  model_2a_ses <- function(y){
    ...
    fit <- svyglm(f_m2a, design=dstrat, na.action=na.exclude)
    fit
  }
