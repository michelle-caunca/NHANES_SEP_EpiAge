...
# Medical conditions
MED <- "https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/1999/DataFiles/MCQ.xpt"

# CBC w/ diff 
CBC <- "https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/1999/DataFiles/LAB25.xpt"
...
load("./mvpa9900.Rdata") # n=4952, v=2
...
# Create categorical PIR (5 [highest] as reference)
